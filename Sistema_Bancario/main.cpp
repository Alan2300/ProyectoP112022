...
void actualizarRegistro( fstream &actualizarArchivo )
{
   ...
   if ( cliente.obtenerNumeroCuenta() != 0 ) {
      ...
      //actualizar el apellido del registro
      cout <<"\desea cambiar el apellido de la cuenta? (1 = si o 0 = No): ";
      bool CApellido = 0;
      cin >> CApellido;
      if (CApellido == 1)
      {
          ...
          cin >> NewApellido;
          string ApellidoAnterior = cliente.obtenerApellido();
          cliente.establecerApellido(NewApellido);
          mostrarLinea( cout, cliente );
      }

      //actualizar el nombre del registro
      cout <<"\desea cambiar el nombre de la cuenta? (1 = si o 0 = No): ";
      bool CNombre = 0;
      cin >> CNombre;
      if (CNombre == 1)
      {
          ...
          cin >> NewNombre;
          string ApellidoAnterior = cliente.obtenerPrimerNombre();
          cliente.establecerPrimerNombre(NewNombre);
          mostrarLinea( cout, cliente );
      }
